...
class SmsDemo
{
    ...
    */
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIKyWT5YMNqtIV"; // AccessKeyId
        
        $accessKeySecret = "nW2BTi0I8cNIDHGyexjZAPJFm7l2ld"; // AccessKeySecret
    ...
    */
    public static function sendSms($phone,$code) {
        ...
        $request->setSignName("登录验证");
        
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_5490107");
